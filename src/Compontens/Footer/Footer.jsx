...
const Footer = () => {
  return (
    //     <div className="px-4 bg-[#212529]  divide-y dark:bg-gray-800 dark:text-gray-100">
    //     <div className="container w-3/4  flex flex-col justify-around py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
    ...
    <div className="bg-[#212529]">
      <div className="w-3/4 mx-auto">
        <div className="flex justify-around py-8">
          ...
          {/* left */}
          <div className=" grid grids-cols-2 gap-2 lg:grid-cols-4 mx-4 text-white">
            <div className="space-y-3">
              <h3 className="tracki uppercase dark:text-gray-50"> Company </h3>
              <ul className="">
                <li>
