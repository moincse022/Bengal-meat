      ...
      <div className="card-body">
        ...
        <div className="flex justify-end absolute bottom-0 left-0 gap-8">
          <button className="btn btn-warning">
            <FaPlus onClick={cartIncrement} className="w-8 h-8" />
          </button>
          <button className="btn btn-warning">
            <FaMinus onClick={cartDecrement} className="w-8 h-8" />
          </button>
          <button className="btn">
            <CiStar className="w-6 h-6 text-amber-400" />
            {rating}
          </button>
        </div>
      </div>
      <figure>
        <img src={img} alt="Movie" className="w-40 h-44" />
      </figure>
    </div>
  );
};
